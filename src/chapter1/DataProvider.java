...
public class DataProvider {
    ...
    private final Map<String, Gender> _givenNames = new
            HashMap<>();
    ...
    private void init() {
        try {
            ...
            readFile("GivenNamesFemale.csv").stream()
                    .forEach(n -> _givenNames.put(n, Gender.Female));
            readFile("GivenNamesMale.csv").stream()
                    .forEach(n -> _givenNames.put(n,
                            Gender.Male));
            int articleNo = 0;
    ...
    private List<String> readFile(String fileName) throws
            IOException {
